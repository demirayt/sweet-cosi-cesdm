...
def build_multienergy_model(schema_dir: Path):
    ...
    m.add_relation(entity_id="D_GAS", relation_id="hasEnergyCarrier", target_entity_id="gas")
    ...
    m.add_relation(entity_id="D_ELEC", relation_id="hasEnergyCarrier", target_entity_id="electricity")

    m.add_entity(entity_class="EnergyDomain", entity_id="D_HEAT")
    m.add_attribute(entity_id="D_HEAT", attribute_id="name", value="Heat")
    m.add_relation(entity_id="D_HEAT", relation_id="hasEnergyCarrier", target_entity_id="heat")
    ...
    # Carrier references
    m.add_relation(entity_id="CHP_1", relation_id="hasFuelCarrier", target_entity_id="gas")
    m.add_relation(entity_id="CHP_1", relation_id="hasElectricityAsCarrier", target_entity_id="electricity")
    m.add_relation(entity_id="CHP_1", relation_id="hasHeatAsCarrier", target_entity_id="heat")
    # Node references
